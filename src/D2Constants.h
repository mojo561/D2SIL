...
enum class D2C_Mod : WORD
{
	...
	SKILL_ON_HIT,
	SKILL_ON_GETHIT,
	GEMBONUS, //properties.txt stat1: 65535
	DURABILITY_OVER_TIME, //properties.txt stat1: 65535
	FIRE_EFFECTS, //properties.txt stat1: 65535
	LIGHTNING_EFFECTS, //properties.txt stat1: 65535
	SOCKETS,
	FIRE_DAMAGE_MINMAX,
	LIGHT_DAMAGE_MINMAX,
	MAGIC_DAMAGE_MINMAX,
	...
	STATS_ITEM_FIND_GEMS_PERLEVEL_MOD, //properties.txt stat1: 65535
	STATS_ITEM_REPLENISH_DURABILITY_MOD,
	STATS_ITEM_REPLENISH_QUANTITY_MOD,
	STATS_ITEM_EXTRA_STACK_MOD,
	STATS_ITEM_FIND_ITEM_MOD, //properties.txt stat1: 65535
	STATS_ITEM_SLASH_DAMAGE_MOD, //properties.txt stat1: 65535
	STATS_ITEM_SLASH_DAMAGE_PERCENT_MOD, //properties.txt stat1: 65535
	STATS_ITEM_CRUSH_DAMAGE_MOD, //properties.txt stat1: 65535
	STATS_ITEM_CRUSH_DAMAGE_PERCENT_MOD, //properties.txt stat1: 65535
	STATS_ITEM_THRUST_DAMAGE_MOD, //properties.txt stat1: 65535
	STATS_ITEM_THRUST_DAMAGE_PERCENT_MOD, //properties.txt stat1: 65535
	STATS_ITEM_ABSORB_SLASH_MOD, //properties.txt stat1: 65535
	STATS_ITEM_ABSORB_CRUSH_MOD, //properties.txt stat1: 65535
	STATS_ITEM_ABSORB_THRUST_MOD, //properties.txt stat1: 65535
	STATS_ITEM_ABSORB_SLASH_PERCENT_MOD, //properties.txt stat1: 65535
	STATS_ITEM_ABSORB_CRUSH_PERCENT_MOD, //properties.txt stat1: 65535
	STATS_ITEM_ABSORB_THRUST_PERCENT_MOD, //properties.txt stat1: 65535
	...
	STATS_ITEM_FIND_GEMS_BYTIME_MOD, //properties.txt stat1: 65535
	STATS_ITEM_PIERCE_COLD_MOD,
	STATS_ITEM_PIERCE_FIRE_MOD,
	STATS_ITEM_PIERCE_LTNG_MOD,
	STATS_ITEM_PIERCE_POIS_MOD,
	STATS_ITEM_DAMAGE_VS_MONSTER_MOD, //properties.txt stat1: 65535
	STATS_ITEM_DAMAGE_PERCENT_VS_MONSTER_MOD, //properties.txt stat1: 65535
	STATS_ITEM_TOHIT_VS_MONSTER_MOD, //properties.txt stat1: 65535
	STATS_ITEM_TOHIT_PERCENT_VS_MONSTER_MOD, //properties.txt stat1: 65535
...
*/
enum class D2C_ItemQuality
{
   ITEMQUALITY_CRACKED = 1, //(LowQualityItems.txt)
   ITEMQUALITY_NORMAL,
   ITEMQUALITY_SUPERIOR,
   ITEMQUALITY_MAGIC,
   ITEMQUALITY_SET, //(SetItems.txt)
   ITEMQUALITY_RARE,
   ITEMQUALITY_UNIQUE, //(proof: D2Game.dll+0x10B29)
   ITEMQUALITY_CRAFTED,
...
v1.10...
Credit: https://d2mods.info/forum/viewtopic.php?p=112269#p112269
itemdata +0x18 flags
*/
enum class D2C_ItemFlags
{
    ITEMFLAG_NEWITEM          = 0x00000001,		//TODO:test (always 0?)
	ITEMFLAG_TARGETING        = 0x00000004,
    ITEMFLAG_IS_IDENTIFIED    = 0x00000010,		//seems to be correct
...
{
	ITEMCODE_GOLD = 0x20646c67,
	ITEMCODE_FULLREJUV = 0x206c7672,
	ITEMCODE_REJUV = 0x20737672,
	ITEMCODE_STAMINA = 0x20737076,
...
Item types
see: ItemTypes.txt, these are row indices...

*/
enum class D2C_ItemTypes
{
	ITEMTYPE_RING = 0xA,
	ITEMTYPE_AMULET = 0xC,
	...
	ITEMTYPE_CHARM_SMALL = 0x52,
	ITEMTYPE_CHARM_LARGE = 0x53,
	ITEMTYPE_CHARM_GRAND = 0x54
};
...
enum class D2C_Difficulty : BYTE
{
	Normal = 0,
	Nightmare,
	Hell
